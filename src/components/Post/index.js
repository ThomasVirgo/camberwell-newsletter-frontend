...
const Post = ({info, toggleModal}) => {
    ...
    return (
        <div onClick={() => toggleModal(info)} className="relative bg-white py-3 px-6 rounded-3xl w-80 h-80 my-4 shadow-xl hover:bg-gray-200 hover:cursor-pointer">
            <div className="mt-8">
                <p className="text-lg font-semibold my-2 hover:cursor-pointer">{info.title}</p>
                <div>
