                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                        ...
                        <div className="col-span-3 sm:col-span-2">
                            ...
                            <input onChange={handleChange} type="text" name="title" id="title" className="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300" placeholder="delicious sausage and bean pasta..."/>
                            </div>
                        </div>
                        </div>
